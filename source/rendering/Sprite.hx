...
class Sprite extends FlxSprite{
    ...
    //hscript friendly functions

    public function setScreenCenter(axis:String) {
        switch (axis) {
            default: screenCenter(XY);
            case "XY": screenCenter(XY);
            case "X": screenCenter(X);
            case "Y": screenCenter(Y);
        }
    }
